"""
k1.concierge.actors.back_pool -- BackPool Worker Management (M7 E7.1).
...
if TYPE_CHECKING:
    from k1.concierge.protocols.task_lease import TaskLease
...
class BackPool:
    ...
    def acquire_worker(
        ...
        *,
        ...
        from k1.concierge.protocols.task_lease import create_task_lease
    ...
    async def _reclaim_expired_worker(self, slot: WorkerSlot) -> None:
        ...
        """
        from k1.concierge.protocols.cancellation import CancelReason
