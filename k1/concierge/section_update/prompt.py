...
def build_section_update_system_prompt() -> str:
    ...
    return "\n".join(
        [
            ...
            "The HOT cognitive sections have different jobs: beliefs_active stores current facts; scoreboard stores discourse bookkeeping; clarifications stores open gaps; affective_now stores current emotional tone; narrative_active stores the active conversation thread pointer.",
            "",
            ...
            *allowed_lines,
            ...
            "Affect is the user's present emotional signal: frustrated, relieved, excited, anxious, overwhelmed, upset, proud, worried, or similar.",
