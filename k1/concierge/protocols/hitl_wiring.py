"""
k1.concierge.protocols.hitl_wiring -- Cross-layer HITL wiring helpers.
...
from k1.concierge.prompt.builder import SS_READ_CONFIGS, SSReadConfig
...
from k1.concierge.prompt.sections import ANTI_PATTERN_KEYS, MODE_EXAMPLES, MODE_SECTIONS
...
def validate_hitl_wiring() -> list[str]:
    ...
    try:
        from k1.concierge.fsm.arbiter import InflightContext
