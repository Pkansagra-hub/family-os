"""
k1.concierge.protocols.hitl_coordinator -- FSM-side HITL orchestration.
...
class HILCoordinator:
    ...
    async def handle_needs_human(
        ...
        if writer is not None:
            from k1.concierge.events.hitl import HILRequested as HILRequestedEvt
    ...
    async def handle_user_response(
        ...
        writer = ledger or self._ledger
        if writer is not None:
            from k1.concierge.events.hitl import HILResolved as HILResolvedEvt
