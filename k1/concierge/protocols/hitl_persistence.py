"""
k1.concierge.protocols.hitl_persistence -- HITL persistence model and timeout event.
...
from k1.concierge.protocols.hitl import HILRequest
...
class HILSubTask:
    ...
    def to_hil_request(self) -> HILRequest:
        ...
        """
        from k1.concierge.protocols.hitl import SafetyBand
