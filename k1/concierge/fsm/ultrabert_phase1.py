"""
k1.concierge.fsm.ultrabert_phase1 -- UltraBERT-backed Phase 1 pipeline.
...
from k1.concierge.config.loader import Phase1Config, get_config
...
class UltraBERTPhase1Pipeline:
    ...
    # ------------------------------------------------------------------
    # Multi-factor complexity classifier (E10.1.2) -- removed in P3.4a
    # ------------------------------------------------------------------
    # _compute_complexity() was deleted. Tier is now derived in
    # dispatch_task from `plan: bool` + multi-intent + depends_on signals.
