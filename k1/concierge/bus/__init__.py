"""
k1.concierge.bus -- Bus integration layer for the K1 POC.
...
Usage::
    ...
    from k1.concierge.bus import create_poc_bus, create_poc_router, register_poc_actors
    from k1.concierge.bus import TOPIC_USER_INPUT, build_user_input
"""
...
from k1.concierge.bus.builders import (  # noqa: F401
    BUILDERS,
    BuilderEntry,
    build_affect_update,
...
from k1.concierge.bus.topics import (  # noqa: F401
    ALL_TOPICS,
    BACK_SUBSCRIPTIONS,
    FRONT_SUBSCRIPTIONS,
    RELAXED_TOPICS,
