...
SCENARIO_DATA_TEMPLATES: dict[PromptMode, str] = {
    ...
    PromptMode.PRESENT: (
        ...
        "Semantic guidance / authority boundaries:\n{semantic_guidance}\n"
        "Legacy fallback summary: {task_result_summary}\n"
        "Present what changed naturally in Front's voice. Lead with the useful outcome, "
        "not the internal task. Preserve authority boundaries when provided. Do not dispatch.\n"
