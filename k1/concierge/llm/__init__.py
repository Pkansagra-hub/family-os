...
from k1.concierge.llm.model_selection import (
    DEFAULT_MODEL,
    MODEL_HINT_OVERRIDES,
    MODEL_SELECTION_TABLE,
    select_model,
)
from k1.concierge.llm.ports import IConciergeModelPort
...
# Use: from k1.concierge.llm.gemini_adapter import GeminiConciergeAdapter
