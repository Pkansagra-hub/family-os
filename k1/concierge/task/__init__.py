"""
k1.concierge.task -- Task dispatch model for Concierge orchestration.
...
from k1.concierge.task.bundled_executor import BundledExecutionPlan, IntentResult
from k1.concierge.task.classifier import IntentClassification, build_dispatches, classify_intents
from k1.concierge.task.complexity import TIER_BUDGET, ComplexityTier, budget_for_tier
...
from k1.concierge.task.envelope_bridge import (
...
from k1.concierge.task.receiver import TaskReceiver
from k1.concierge.task.tools import DISPATCH_TASK_SCHEMA, dispatch_task
from k1.concierge.task.topics import (
    ALL_TASK_TOPICS,
    DAG_COMPLETED,
    ORCHESTRATION_DELTA,
    TASK_ACCEPTED,
