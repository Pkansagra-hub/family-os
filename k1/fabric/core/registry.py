"""
k1.fabric.core.registry -- Capability Registry (Subsystem 2).
...
def _contract_to_validation_dict(
    ...
    if isinstance(contract, AgentContract):
        return {"agent_contract": contract.to_dict()}, "agent_contract"
    if isinstance(contract, CapabilityContract):
        return {"tool_contract": contract.to_dict()}, "tool_contract"
    if isinstance(contract, PromptContract):
