...
affected_modules:
  - k1.l3_execution.tool_executor
  - k1.l3_execution.mcp_client
  - k1.l5_infrastructure.mcp_bridge
authors:
...
propagation:
  triggers:
    - Changing MCP protocol specifications
    - Modifying tool integration strategy
    - Updating RPC method signatures
  ...
  affected_tests:
    - tests/k1/l3_execution/test_mcp_client.py
    - tests/k1/l5_infrastructure/test_mcp_bridge.py
related_adrs:
  - ADR-0010
  - ADR-0011
  - ADR-0024
...
superseded_by: []
supersedes: []
title: "0034: MCP Protocol for Tool Integration (Standardized Tool Communication)"
---
...
superseded_by: []
supersedes: []
title: MCP Protocol for Tool Integration
---
