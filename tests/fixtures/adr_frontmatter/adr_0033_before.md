...
affected_modules:
  ...
  - k1.l5_infrastructure.sandbox_manager
authors:
...
propagation:
  triggers:
    ...
    - Changing sandbox strategy
    - Modifying MCP protocol
  affected_adrs:
    - ADR-0010
    - ADR-0032
    - ADR-0032c
    ...
    - ADR-0034
  affected_contracts:
    - k1/contracts/flatbuffers/layer3_execution/tool_execution_request.fbs
  affected_tests:
    - tests/k1/l3_execution/test_tool_executor.py
related_adrs:
  - ADR-0010
  - ADR-0029c
  - ADR-0032
...
research_citations:
  ...
  - "WebAssembly Sandbox: https://webassembly.org/"
status: PROPOSED
superseded_by: []
supersedes: []
title: "0033: Tool Execution Architecture (Protocol + Sandbox Layers)"
---
- ADR-0053c
- ADR-0056
- ADR-0056c
