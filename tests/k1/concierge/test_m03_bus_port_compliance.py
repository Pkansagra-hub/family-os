...
from k1.concierge.bus.setup import (
...
class TestReExports:
    """E3.2 re-exports in k1.concierge.bus are importable."""

    def test_ibus_importable(self):
        from k1.concierge.bus import IBus as IBus_  # noqa: F401

        assert IBus_ is IBus

    def test_imailbox_importable(self):
        from k1.concierge.bus import IMailbox as IMailbox_  # noqa: F401

        assert IMailbox_ is IMailbox

    def test_imailboxrouter_importable(self):
        from k1.concierge.bus import IMailboxRouter as IMailboxRouter_  # noqa: F401

        assert IMailboxRouter_ is IMailboxRouter

    def test_bushandler_importable(self):
        from k1.concierge.bus import BusHandler  # noqa: F401

    def test_subscriptionhandle_importable(self):
        from k1.concierge.bus import SubscriptionHandle  # noqa: F401

    def test_mailboxconfig_importable(self):
        from k1.concierge.bus import MailboxConfig  # noqa: F401
