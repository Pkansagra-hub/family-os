...
from k1.concierge.experience import (
    AffectiveMirror,
    Anticipation,
...
class TestEpic15_1_PackageStructure:
    ...
    def test_package_exports_experience_layer(self):
        from k1.concierge.experience import ExperienceLayer
    ...
    def test_total_export_count(self):
        ...
        import k1.concierge.experience as exp
...
class TestEpic15_10_E2EWiring:
    ...
    def test_no_dependency_on_prompt_builder(self):
        ...
        import k1.concierge.experience.layer as layer_mod
        ...
        assert "from k1.concierge.prompt" not in source
    ...
    def test_no_dependency_on_bus(self):
        ...
        source = inspect.getsource(layer_mod)
        assert "from k1.concierge.bus" not in source
