...
class TestMetricsCollector:
    ...
    def test_emit_all_with_bus(self) -> None:
        ...
        with patch("k1.concierge.bus.builders.build_metric_emitted") as mock_builder:
    ...
    def test_emit_all_handles_builder_error(self) -> None:
        ...
        with patch(
            "k1.concierge.bus.builders.build_metric_emitted", side_effect=RuntimeError("boom")
        ):
            count = mc.emit_all()
            assert count == 0
...
class TestMetricBuilders:
    ...
    def test_build_metric_emitted(self) -> None:
        from k1.concierge.bus.builders import build_metric_emitted
        from k1.concierge.bus.topics import TOPIC_METRIC_EMITTED
    ...
    def test_build_metric_alert(self) -> None:
        from k1.concierge.bus.builders import build_metric_alert
        from k1.concierge.bus.topics import TOPIC_METRIC_ALERT
    ...
    def test_build_metric_session_summary(self) -> None:
        from k1.concierge.bus.builders import build_metric_session_summary
        from k1.concierge.bus.topics import TOPIC_METRIC_SESSION_SUMMARY
