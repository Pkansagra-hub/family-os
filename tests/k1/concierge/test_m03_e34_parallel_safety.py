...
class TestConfigToggle:
    ...
    def test_config_default_is_true(self):
        ...
        from k1.concierge.config.loader import ReactConfig
    ...
    async def test_parallel_disabled_forces_sequential(self):
        ...
        with patch("k1.concierge.react.loop.get_config") as mock_cfg:
            cfg = MagicMock()
...
class TestStaleConstants:
    ...
    def test_mode_max_iterations_importable(self):
        ...
        from k1.concierge.react.loop import MODE_MAX_ITERATIONS
    ...
    def test_crisis_max_iterations_importable(self):
        ...
        from k1.concierge.react.loop import CRISIS_MAX_ITERATIONS
    ...
    def test_get_mode_max_iterations_function_exists(self):
        ...
        from k1.concierge.react.loop import get_mode_max_iterations
    ...
    def test_get_crisis_max_iterations_function_exists(self):
        ...
        from k1.concierge.react.loop import get_crisis_max_iterations
...
class TestSubmitResultGuard:
    ...
    async def test_submit_result_with_other_tools_logs_warning(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="k1.concierge.react.loop"):
            result = await react_loop(
                actor="back",
                system_prompt="test",
                messages=[],
...
class TestReactLoopClassifiedExecution:
    ...
    async def test_classification_logged(self, caplog):
        ...
        with caplog.at_level(logging.INFO, logger="k1.concierge.react.loop"):
            result = await react_loop(
                actor="front",
                system_prompt="test",
                messages=[],
