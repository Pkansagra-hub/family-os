...
class TestArbiterResult:
    ...
    def test_importable_from_module(self):
        from poc.k1_poc.fsm.arbiter import ArbiterDecision as AD
        from poc.k1_poc.fsm.arbiter import ArbiterResult as AR
...
class TestArbiterClassify:
    ...
    def setup_method(self):
        from poc.k1_poc.config.loader import ArbiterConfig
...
class TestArbiterConfig:
    ...
    def test_config_round_trip_builder(self):
        ...
        from poc.k1_poc.config.loader import _build_arbiter
