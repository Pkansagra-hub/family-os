...
class TestResumeHandlerEnvelopeContext:
    ...
    async def test_primary_path_uses_resume_context(self):
        ...
        from poc.k1_poc.actors.back import _serialize_messages
        ...
        with patch(
            "poc.k1_poc.actors.back.react_loop", new_callable=AsyncMock, return_value=result
        ):
            with patch("poc.k1_poc.actors.back._emit_back_result"):
                with patch("poc.k1_poc.actors.back._clear_pending_context"):
...
class TestDeprecatedContextHelpers:
    ...
    def test_store_pending_context_has_deprecation_notice(self):
        ...
        from poc.k1_poc.actors.back import store_pending_context
    ...
    def test_get_pending_context_has_deprecation_notice(self):
        ...
        from poc.k1_poc.actors.back import _get_pending_context
    ...
    def test_clear_pending_context_has_deprecation_notice(self):
        ...
        from poc.k1_poc.actors.back import _clear_pending_context
...
class TestEmitBackResultReactHistory:
    ...
    def test_suspended_includes_react_history(self):
        ...
        from poc.k1_poc.actors.back import _emit_back_result
...
class TestMessageSerialization:
    ...
    def test_deserialize_basic_messages(self):
        ...
        from poc.k1_poc.actors.back import _deserialize_messages
    ...
    def test_roundtrip_preserves_data(self):
        ...
        from poc.k1_poc.actors.back import _deserialize_messages, _serialize_messages
...
class TestResumeFlowIntegration:
    ...
    async def test_end_to_end_resume_with_envelope_context(self):
        ...
        from poc.k1_poc.actors.back import _serialize_messages, back_resume_handler
        ...
        with patch(
            "poc.k1_poc.actors.back.react_loop",
