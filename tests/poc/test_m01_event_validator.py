...
from poc.k1_poc.events.conversation import DeadLettered, IntentArbitrated, UserInputReceived
...
from poc.k1_poc.events.validator import EVENT_SCHEMA_REGISTRY, validate_event, validate_event_chain
from poc.k1_poc.events.weave import WeaveCandidateArrived, WeaveDecisionMade, WeaveEmitted
...
class TestBuilderValidationWiring:
    ...
    def test_config_flag_exists(self) -> None:
        from poc.k1_poc.config.loader import BusConfig
    ...
    def test_builder_with_valid_canonical_event(self) -> None:
        ...
        from poc.k1_poc.bus.builders import build_task_complete
...
class TestHitlWiringCanonicalChecks:
    ...
    def test_hitl_wiring_passes_with_canonical_checks(self) -> None:
        from poc.k1_poc.protocols.hitl_wiring import validate_hitl_wiring
...
class TestTypeSpecificFieldIntrospection:
    ...
    def test_task_completed_fields(self) -> None:
        from poc.k1_poc.events.validator import _get_type_specific_fields
