...
from poc.k1_poc.fsm.transition_table import TRIGGER_SAME_TURN_COMPLETE, is_legal
from poc.k1_poc.protocols.weave_state import WeaveAction, get_weave_action
...
class TestFrontEmitOrdering:
    ...
    async def test_dispatch_emitted_before_final_response(self):
        ...
        with (
            patch("poc.k1_poc.actors.front.react_loop", return_value=result),
            patch("poc.k1_poc.actors.front.determine_mode") as mock_mode,
            patch("poc.k1_poc.actors.front.DynamicPromptBuilder") as mock_builder,
            patch("poc.k1_poc.react.history.build_chat_history", return_value=[]),
            patch("poc.k1_poc.actors.front.compute_affect_band", return_value="calm"),
            patch("poc.k1_poc.actors.front.LLMOutputValidator", return_value=None),
            patch("poc.k1_poc.actors.front.get_config") as mock_config,
        ):
...
class TestBusSubscriptionRoutingInvariant:
    ...
    def test_fsm_routed_disjoint_from_front_subscriptions(self):
        ...
        from poc.k1_poc.bus.topics import FRONT_SUBSCRIPTIONS, FSM_ROUTED_TOPICS
    ...
    def test_back_subscriptions_disjoint_from_front_subscriptions(self):
        ...
        from poc.k1_poc.bus.topics import BACK_SUBSCRIPTIONS, FRONT_SUBSCRIPTIONS
    ...
    def test_fsm_routed_topics_count(self):
        ...
        from poc.k1_poc.bus.topics import FSM_ROUTED_TOPICS
...
class TestBuilderPriorityConsistency:
    ...
    def test_all_builders_match_topic_priority(self):
        ...
        from poc.k1_poc.bus.topics import get_priority
    ...
    def test_urgent_topics_have_urgent_priority_in_builders(self):
        ...
        from poc.k1_poc.bus.builders import BUILDERS
        from poc.k1_poc.bus.topics import URGENT_TOPICS
...
class TestTopicDeduplication:
    ...
    def test_all_task_topics_are_identity_matches(self):
        ...
        from poc.k1_poc.bus import topics as bus_topics
        from poc.k1_poc.task import topics as task_topics
    ...
    def test_all_task_topics_set_matches_bus_subset(self):
        ...
        from poc.k1_poc.bus.topics import ALL_TOPICS
        from poc.k1_poc.task.topics import ALL_TASK_TOPICS
