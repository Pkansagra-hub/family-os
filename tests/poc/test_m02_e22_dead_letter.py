...
from poc.k1_poc.bus.builders import build_dead_letter, build_task_cancel, build_tool_started
...
from poc.k1_poc.fsm.dead_letter import DeadLetterPayload, build_dead_letter_payload
from poc.k1_poc.fsm.dead_letter_consumer import DeadLetterConsumer
from poc.k1_poc.fsm.turn_state import FSMTurnState
from poc.k1_poc.protocols.weave_batcher import WeaveBatcher, WeaveResult
from poc.k1_poc.protocols.weave_state import PendingResult, PendingResultsQueue, WeaveAction
...
class TestDeadLetterConsumer:
    ...
    def _make_consumer(self):
        from poc.k1_poc.bus.setup import create_poc_bus
