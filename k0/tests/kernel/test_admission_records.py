...
def _build_request() -> Request:
    ...
    scope["app"] = SimpleNamespace(state=SimpleNamespace(observability_emitter=None))
...
def test_admission_records_capture_decision_context_and_clear_after_consumption() -> None:
    ...
    assert record.sanitized_body_sha256 is None
    assert record.original_body_sha256 is None
