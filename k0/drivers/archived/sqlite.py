...
.. deprecated:: 0.4.0
    SQLite driver is deprecated in favor of PostgreSQL driver (postgres.py).
    Use PostgresDriver for all new code. This driver will be removed in v1.0.0.
...
warnings.warn(
    "k0.drivers.sqlite is deprecated. Use k0.drivers.postgres instead. "
    "SQLite driver will be removed in v1.0.0.",
    DeprecationWarning,
    stacklevel=2,
)
...
class SQLiteDriver:
    ...
    .. deprecated:: 0.4.0
        Use PostgresDriver from k0.drivers.postgres instead.
    ...
    def __init__(self, database_path: Path, cognitive_trace_id: str | None = None) -> None:
        ...
        """
        warnings.warn(
            "SQLiteDriver is deprecated. Use PostgresDriver from k0.drivers.postgres instead.",
            DeprecationWarning,
            stacklevel=2,
        )
