"""FSM Controller for Anniversary Demo.

Ported from ``concierge_fsm_poc/fsm/controller.py``.
Pure-logic deterministic FSM with zero I/O -- table-driven transitions.

8 states, 14 events, 15 actions, 18 transition-table entries.
