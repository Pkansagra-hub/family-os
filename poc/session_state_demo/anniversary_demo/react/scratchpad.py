"""Scratchpad, Finding, and LoopBudget models for the anniversary demo.

Ported from ``concierge_fsm_poc/react/scratchpad.py``.

Key adaptations vs the FSM PoC version:

* ``State`` imported from local ``fsm_controller.py``.
* ``COGNITIVE_TOOLS`` mapped to anniversary demo tool names:
...
from poc.session_state_demo.anniversary_demo.fsm_controller import State
