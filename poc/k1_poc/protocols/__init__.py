"""
poc.k1_poc.protocols -- Task lifecycle protocols for cooperative cancellation,
...
from poc.k1_poc.protocols.cancel_events import TaskCancelEvent, TaskFailedCancelledEvent
...
from poc.k1_poc.protocols.hitl import HILRequest, HILResponse, SafetyBand, escalate_safety_band
from poc.k1_poc.protocols.hitl_coordinator import (
    HIL_TO_SUSPENSION,
    HILCoordinator,
    HILCoordinatorConfig,
)
from poc.k1_poc.protocols.hitl_flow import (
    ApprovalContext,
...
from poc.k1_poc.protocols.hitl_persistence import (
    CrashRecoveryReport,
    HILTimeoutEvent,
    TaskStateEntry,
    TaskStatus,
...
from poc.k1_poc.protocols.hitl_pipeline import (
    ApprovalResult,
    SelectionResult,
...
from poc.k1_poc.protocols.hitl_wiring import (
    RESUME_INSTRUCTIONS,
    HILModeConfig,
    ResumeContext,
...
from poc.k1_poc.protocols.suspension_events import TaskResumeEvent, TaskSuspendedEvent
from poc.k1_poc.protocols.suspension_manager import SuspensionManager
from poc.k1_poc.protocols.weave_batcher import WEAVE_BATCH_WINDOW_MS, WeaveBatcher, WeaveResult
from poc.k1_poc.protocols.weave_state import (
    STATE_ACTION_TABLE,
    PendingResult,
    PendingResultsQueue,
    WeaveAction,
