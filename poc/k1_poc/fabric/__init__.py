...
from poc.k1_poc.fabric.capability_registry import CapabilityRegistry, create_demo_registry
from poc.k1_poc.fabric.demo_capabilities import DEMO_CAPABILITIES
from poc.k1_poc.fabric.family_capabilities import FAMILY_CAPABILITIES, register_family_capabilities
