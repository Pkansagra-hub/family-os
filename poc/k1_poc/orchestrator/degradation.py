"""
poc.k1_poc.orchestrator.degradation -- Tier degradation cascade.
...
from poc.k1_poc.orchestrator.routing import DispatchRecord, EmitFn, route_task
from poc.k1_poc.orchestrator.types import CannedResponse
