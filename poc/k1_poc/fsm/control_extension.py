"""
poc.k1_poc.fsm.control_extension -- ConciergeControlExtension.
...
sub-fields for task tracking and adds fsm_state as a lightweight
in-memory field that is serialized alongside.
...
Why a wrapper instead of modifying ControlSection directly:
  ...
  3. The POC extension is 2 fields -- not worth schema churn.
...
class ConciergeControlExtension:
    ...
    Tracks the FSM-specific fields that the existing ControlSection
