...
title: "RED Method Metric Schema (Rate, Errors, Duration)"
...
propagation:
  triggers:
    - "Adding new RED metric types"
    - "Changing metric label structure"
    - "Modifying histogram bucket boundaries"
  affected_adrs:
    - ADR-0004
    - ADR-0029
    - ADR-0029b
  ...
  affected_contracts: []
  affected_tests:
    - tests/k1/l4_runtime/test_red_metrics.py

# Research Citations
research_citations:
  - "RED Method (Wilkie 2015) - Rate, Errors, Duration"
  - "Prometheus Metric Types - Counter, Gauge, Histogram, Summary"
  - "Histogram vs Summary - Quantile Estimation Trade-offs"
  - "Prometheus Naming Best Practices - Metric & Label Conventions"
- ADR-0030a
- ADR-0041
related_contracts: []
related_diagrams: []
