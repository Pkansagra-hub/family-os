...
- k1.l2_orchestration.validation.static_checker
- k1.l2_orchestration.validation.dynamic_tester
- k1.l2_orchestration.validation.capability_validator
- k1.l2_orchestration.validation.dag_cycle_detector
- k1.l3_execution.model_hub.arbiter_llm
- k1.l4_runtime.sessionstate.validation_cache
concerns:
- architecture
- cost
- observability
...
- k1/contracts/flatbuffers/layer2_orchestration/validation_result.fbs
- k1/contracts/flatbuffers/layer2_orchestration/static_validation.fbs
- k1/contracts/flatbuffers/layer2_orchestration/dynamic_validation.fbs
- k1/contracts/flatbuffers/layer3_execution/arbiter_request.fbs
- k1/contracts/flatbuffers/layer4_runtime/validation_cache.fbs
...
related_diagrams:
- k1_validation_stage_2tier_architecture
- k1_static_validation_workflow
- k1_dynamic_validation_testing
- k1_capability_validation_logic
- k1_dag_cycle_detection_algorithm
- k1_arbiter_llm_integration
- k1_validation_cache_optimization
research_citations:
- "STRIPS: A New Approach to the Application of Theorem Proving to Problem Solving" by Richard Fikes and Nils Nilsson (1971)
- "Topological Sorting of Large Networks" by Arthur B. Kahn (1962)
- "Constitutional AI: Harmlessness from AI Feedback" by Anthropic (2022)
- "Planning Domain Definition Language (PDDL)" by Drew McDermott et al. (1998)
- "Automated Planning and Acting" by Malik Ghallab et al. (2016)
- "Capability-Based Security" by Jack B. Dennis and Earl C. Van Horn (1966)
propagation:
  triggers:
  ...
  - tests/k1/l2_orchestration/test_static_checker.py
  - tests/k1/l2_orchestration/test_dynamic_tester.py
  - tests/k1/l2_orchestration/test_capability_validator.py
  - tests/k1/l2_orchestration/test_dag_cycle_detector.py
  - tests/k1/l3_execution/test_arbiter_llm.py
  - tests/k1/l4_runtime/test_validation_cache.py
  - tests/integration/test_validation_stage_pipeline.py
