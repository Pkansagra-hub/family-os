...
related_adrs:
  ...
  - ADR-0018  # Eviction Strategy
  - ADR-0019  # FlatBuffers SessionState
  - ADR-0020  # Multi-Tier Storage
  - ADR-0021a  # Retention Policy Engine
  - ADR-0021b  # Privacy Band Overrides
  - ADR-0021c  # Compliance Reporting
  - ADR-0022  # K0 Bridge Batching
  - ADR-0023  # Cursor Pagination
  - ADR-0050a  # Multi-Device Sync
...
propagation:
  triggers:
    - "Changing retention policy durations (24h → other)"
    - "Adding new privacy band with different retention"
    - "Modifying K0 WAL cleanup schedules"
    - "Implementing GDPR/CCPA right-to-delete"
  affected_adrs:
    - ADR-0017  # SessionState structure changes
    - ADR-0018  # Eviction must align with retention
    - ADR-0020  # Storage tiers must enforce retention
    - ADR-0035  # PII detection affects retention
    - ADR-0038  # Audit trail retention
  affected_contracts:
    - k1/contracts/privacy/audit_trail/retention_policies.yml
    - k0/contracts/api/rest/idempotency/24h_retention.yml
  affected_tests:
    - tests/k0/storage/test_retention_policies.py
    - tests/k1/l5_infrastructure/test_storage_lifecycle.py

# Research Citations
research_citations:
  - "GDPR Article 17 (Right to Erasure) - EU 2016/679"
  - "CCPA §1798.105 (Right to Delete) - California 2020"
  - "HIPAA §164.530(j) - Retention & Disposal Requirements"
- CloudWatch (2009)
- GDPR (2018)
- HIPAA (1996)
- Slack (2013)
