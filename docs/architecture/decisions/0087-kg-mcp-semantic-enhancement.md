---
adr_number: 0087
title: Kg Mcp Semantic Enhancement
status: PROPOSED
...
propagation:
  triggers:
  - AI agent calls single tool → gets complete, interconnected context
  - AI agent must manually search repo → read ADRs → find contracts → locate code
