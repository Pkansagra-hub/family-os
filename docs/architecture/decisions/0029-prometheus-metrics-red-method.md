...
related_contracts:
- k0/contracts/api/rest/idempotency/observability.yml
- k0/contracts/api/rest/sessions/observability.yml
- k0/contracts/api/websocket/backpressure/observability.yml
- k0/contracts/api/websocket/reconnection/observability.yml
- k1/contracts/api/rest/documentation/observability.yml
- k1/contracts/api/rest/pagination/observability.yml
- k1/contracts/api/rest/sessions/observability.yml
- k1/contracts/api/websocket/connection/observability.yml
- k1/contracts/api/websocket/protocol/observability.yml
- k1/contracts/infrastructure/backpressure/observability.yml
- k1/contracts/infrastructure/backpressure/propagation/observability.yml
- k1/contracts/infrastructure/backpressure/recovery/observability.yml
- k1/contracts/observability/receipts/schema/observability.yml
- k1/contracts/observability/receipts/wal/observability.yml
- k1/contracts/privacy/retention_overrides/observability.yml
- k1/contracts/security/jwt/generation/observability.yml
- k1/contracts/security/jwt/validation/observability.yml
related_diagrams: []
research_citations:
- Metrics (2021)
- Practices (2014)
