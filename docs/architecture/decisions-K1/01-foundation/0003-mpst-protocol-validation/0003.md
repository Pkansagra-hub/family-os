...
- Yoshida, N., Hu, R., Neykova, R., Ng, N. (2013). The Scribble Protocol Language.
  TOOLS 2013.
- Hüttel, H., Lanese, I., Vasconcelos, V., et al. (2016). Foundations of Session Types
  and Behavioural Contracts. ACM Computing Surveys, Vol. 49, No. 1.
- Ancona, D., Dagnino, F., Zucca, E. (2019). Detecting Deadlocks in Multiparty Session
  Types. COORDINATION 2019.
- Neykova, R., Yoshida, N. (2017). Let It Recover: Multiparty Protocol-Induced Recovery.
    CC 2017.
status: IMPLEMENTED
superseded_by: []
supersedes:
