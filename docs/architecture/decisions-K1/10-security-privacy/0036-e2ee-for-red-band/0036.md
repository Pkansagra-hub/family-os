...
affected_modules:
  - k1.l5_infrastructure.e2ee_orchestrator
  - k1.l5_infrastructure.red_band_encryption
  - k1.l4_runtime.e2ee_session_context
authors:
...
propagation:
  triggers:
    - Enabling E2EE for RED band data
    - Changing key derivation or encryption algorithms
    - Modifying session binding rules
    - Adding new RED band data types
  affected_adrs:
    - ADR-0017
    - ADR-0032
    - ADR-0035
    - ADR-0036
  affected_contracts:
    - k1/contracts/flatbuffers/layer5_infrastructure/e2ee_session.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/red_band_envelope.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/key_agreement.fbs
  affected_tests:
    - tests/k1/l5_infrastructure/test_e2ee_orchestrator.py
    - tests/k1/l5_infrastructure/test_red_band_encryption.py
    - tests/k1/l4_runtime/test_e2ee_session_context.py
related_adrs:
  - ADR-0017
  - ADR-0031a
  - ADR-0032
