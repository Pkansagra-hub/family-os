...
affected_modules:
  - k1.l5_infrastructure.pii_detector
  - k1.l5_infrastructure.pii_redactor
  - k1.l4_runtime.pii_context_manager
authors:
...
propagation:
  triggers:
    - Detecting PII patterns (email, phone, SSN, credit card)
    - Changing redaction strategies
  ...
  affected_adrs:
    ...
    - ADR-0036b
  affected_contracts:
    - k1/contracts/flatbuffers/layer5_infrastructure/pii_detection_result.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/pii_pattern.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/redaction_policy.fbs
  affected_tests:
    - tests/k1/l5_infrastructure/test_pii_detector.py
    - tests/k1/l5_infrastructure/test_pii_redactor.py
    - tests/k1/l4_runtime/test_pii_context_manager.py
related_adrs:
  - ADR-0006
  - ADR-0007
  - ADR-0010
