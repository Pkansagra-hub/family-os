...
affected_modules:
  - k1.l4_runtime.band_override_manager
  - k1.l5_infrastructure.backpressure_controller
  - k1.l5_infrastructure.resource_tier_manager
authors:
...
propagation:
  triggers:
    - User requests privacy band override
    - Enabling lower privacy band access
    - Changing resource tier status
  ...
  affected_adrs:
    ...
    - ADR-0039
  affected_contracts:
    - k1/contracts/flatbuffers/layer4_runtime/band_override_request.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/backpressure_signal.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/resource_tier_status.fbs
  affected_tests:
    - tests/k1/l4_runtime/test_band_override_manager.py
    - tests/k1/l5_infrastructure/test_backpressure_controller.py
    - tests/k1/l5_infrastructure/test_resource_tier_manager.py
related_adrs:
  - ADR-0017
  - ADR-0030c
  - ADR-0032
