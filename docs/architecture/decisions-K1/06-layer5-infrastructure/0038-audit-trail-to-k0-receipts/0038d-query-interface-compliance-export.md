...
adr_number: "0038d"
parent_adr: "ADR-0038"
title: "0038d: Query Interface & Compliance Export"
status: PROPOSED
...
affected_modules:
  - k0.receipts.query_engine
  - k1.l5_infrastructure.compliance_exporter
  - k1.l5_infrastructure.receipt_query_service
concerns:
  - architecture
  - compliance
  - cost
...
research_citations:
  ...
  - HIPAA 164.308: Audit controls requirement
propagation:
  triggers:
    - Running compliance queries
    - Exporting audit reports
    - Generating DSAR responses
  ...
  affected_adrs:
    ...
    - ADR-0038d
  affected_contracts:
    - k0/contracts/receipts/query_request.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/export_manifest.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/dsar_response.fbs
  affected_tests:
    - tests/k0/receipts/test_query_engine.py
    - tests/k1/l5_infrastructure/test_compliance_exporter.py
    - tests/k1/l5_infrastructure/test_receipt_query_service.py
