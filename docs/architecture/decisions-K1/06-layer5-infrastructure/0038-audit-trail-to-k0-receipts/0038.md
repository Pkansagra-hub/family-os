...
affected_modules:
  - k1.l2_orchestration.receipt_orchestrator
  - k0.receipts.receipt_engine
  - k1.l5_infrastructure.audit_receipt_logger
authors:
...
propagation:
  ...
  affected_contracts:
    ...
    - k1/contracts/flatbuffers/layer2_orchestration/execution_receipt.fbs
    - k1/contracts/flatbuffers/layer5_infrastructure/audit_event_receipt.fbs
  affected_tests:
    - tests/k0/receipts/test_receipt_engine.py
    - tests/k1/l2_orchestration/test_receipt_orchestrator.py
    - tests/k1/l5_infrastructure/test_audit_receipt_logger.py
related_adrs:
  - ADR-0015d
  - ADR-0017
  - ADR-0031d
