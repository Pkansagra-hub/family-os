...
affected_modules:
  - k1.l1_input.ingress
  - k1.l2_orchestration.performance
  - k1.l3_execution.agents
  - k1.l4_runtime.metrics
  - k1.l5_infrastructure.monitoring
...
propagation:
  triggers:
    - "Changing P95 performance targets (TTFT, E2E latency)"
    - "Adding new performance budget categories"
    - "Modifying graceful degradation thresholds"
  affected_adrs:
    - ADR-0024a
    - ADR-0024b
    - ADR-0024c
  ...
  affected_contracts:
    - k0/contracts/openapi.k0.yaml
  affected_tests:
    - tests/k1/l4_runtime/test_performance_budgets.py

# Research Citations
research_citations:
  - "Google RAIL Model - Response, Animation, Idle, Load Performance"
  - "Netflix Chaos Engineering (2018) - Performance Under Load"
- ADR-0066
- ADR-0068
- ADR-0070
- ADR-0071
