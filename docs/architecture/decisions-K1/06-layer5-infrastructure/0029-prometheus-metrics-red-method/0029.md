...
affected_modules:
  ...
  - k1.l5_infrastructure.prometheus
...
propagation:
  triggers:
    - "Adding new RED metrics (Rate/Errors/Duration)"
    - "Modifying metric label schemas"
    - "Changing Prometheus scrape intervals"
  affected_adrs:
    - ADR-0024
    - ADR-0028
    - ADR-0029a
  ...
  affected_contracts:
    - k0/contracts/openapi.k0.yaml
  affected_tests:
    - tests/k1/l4_runtime/test_metrics.py

# Research Citations
research_citations:
  - "Google SRE Book - The Four Golden Signals"
  - "RED Method (Wilkie 2015) - Rate, Errors, Duration for Request-Driven Services"
  - "USE Method (Gregg 2012) - Utilization, Saturation, Errors for Resources"
  - "Prometheus Best Practices - Metric Naming & Label Conventions"
- ADR-0030a
- ADR-0030c
- ADR-0031
- ADR-0031d
