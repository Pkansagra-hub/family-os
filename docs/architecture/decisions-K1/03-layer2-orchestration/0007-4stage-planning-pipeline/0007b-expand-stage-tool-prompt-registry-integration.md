---
adr_number: 0007b
title: Expand Stage Tool/Prompt Registry Integration
status: ACCEPTED
...
- k1.l2_orchestration.prompt_registry.semantic_matcher
- k1.l2_orchestration.tool_discovery.capability_matcher
- k1.l2_orchestration.registry.schema_validator
- k1.l3_execution.tools.registry
- k1.l3_execution.model_hub.prompt_library
- k1.l4_runtime.sessionstate.expanded_plan_cache
concerns:
- architecture
- cost
- observability
...
- k1/contracts/flatbuffers/layer2_orchestration/tool_discovery.fbs
- k1/contracts/flatbuffers/layer2_orchestration/schema_validation.fbs
- k1/contracts/flatbuffers/layer3_execution/tools_registry.fbs
- k1/contracts/flatbuffers/layer3_execution/prompt_library.fbs
- k1/contracts/flatbuffers/layer4_runtime/plan_cache.fbs
...
- k1_prompt_registry_semantic_matching
- k1_tool_discovery_capability_matching
- k1_schema_validation_workflow
- k1_registry_pattern_architecture
- k1_expanded_plan_cache
research_citations:
- "Design Patterns: Elements of Reusable Object-Oriented Software" by Erich Gamma et al. (1994)
- "JSON Schema: A Media Type for Describing JSON Documents" (2020)
- "Semantic Matching in Service-Oriented Architectures" by M. Paolucci et al. (2002)
- "Capability-Based Access Control" by Dennis and Van Horn (1966)
- "Registry Pattern Implementation" by Martin Fowler (2004)
- "Schema Validation for API Design" by OpenAPI Initiative (2023)
propagation:
  triggers:
  - '**Prompt matching accuracy** (90% success rate, 10% miss)'
  ...
  - tests/k1/l2_orchestration/test_tool_discovery.py
  - tests/k1/l2_orchestration/test_schema_validator.py
  - tests/k1/l3_execution/test_tools_registry.py
  - tests/k1/l3_execution/test_prompt_library.py
  - tests/k1/l4_runtime/test_expanded_plan_cache.py
  - tests/integration/test_expand_stage_pipeline.py
  - tests/performance/test_registry_matching_latency.py
---
