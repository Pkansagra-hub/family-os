...
- layer4_runtime
affected_modules:
- k1.l2_orchestration.saga.failure_detection
- k1.l2_orchestration.saga.recovery_strategy_selector
- k1.l2_orchestration.saga.forward_recovery
- k1.l2_orchestration.saga.backward_recovery
- k1.l3_execution.flow_engine.failure_handler
- k1.l4_runtime.sessionstate.recovery_state
- k1.l5_infrastructure.circuit_breaker.recovery_integration
concerns:
- architecture
- compliance
- cost
...
implementation_date: '2025-02-10'
implementation_phase: MVP
related_contracts:
- k1/contracts/flatbuffers/layer2_orchestration/failure_detection.fbs
- k1/contracts/flatbuffers/layer2_orchestration/recovery_strategy.fbs
- k1/contracts/flatbuffers/layer2_orchestration/forward_recovery.fbs
- k1/contracts/flatbuffers/layer2_orchestration/backward_recovery.fbs
- k1/contracts/flatbuffers/layer3_execution/failure_handler.fbs
- k1/contracts/flatbuffers/layer4_runtime/recovery_state.fbs
...
related_diagrams:
- k1_forward_vs_backward_recovery
- k1_failure_detection_classification
- k1_recovery_strategy_selection
- k1_forward_recovery_flow
- k1_backward_recovery_flow
- k1_circuit_breaker_recovery_integration
research_citations:
- "Release It!: Design and Deploy Production-Ready Software" by Michael T. Nygard (2007)
- "Exponential Backoff And Jitter" by AWS Architecture Blog (2015)
- "Building Reliable Distributed Systems" by Azure Reliability Documentation
- "Fault Tolerance in Distributed Systems" by Nancy Lynch (1996)
- "Recovery-Oriented Computing" by David Patterson et al. (2002)
- "Self-Healing Systems" by Roy Friedman and Erich Nahum (2004)
propagation:
  triggers:
  ...
  - k1/contracts/flatbuffers/layer3_execution/stream_config.fbs
  affected_tests:
- tests/k1/l2_orchestration/test_failure_detection.py
- tests/k1/l2_orchestration/test_recovery_strategy_selector.py
- tests/k1/l2_orchestration/test_forward_recovery.py
- tests/k1/l2_orchestration/test_backward_recovery.py
- tests/k1/l3_execution/test_failure_handler.py
- tests/k1/l4_runtime/test_recovery_state.py
- tests/k1/l5_infrastructure/test_circuit_breaker_recovery.py
- tests/integration/test_recovery_strategies.py
- tests/performance/test_recovery_latency.py
---
