...
- k1.l2_orchestration.saga.rollback_orchestrator
- k1.l3_execution.flow_engine.saga_integration
- k1.l4_runtime.sessionstate.saga_state
- k1.l5_infrastructure.persistence.saga_log
concerns:
- architecture
- compliance
- cost
...
- k1/contracts/flatbuffers/layer2_orchestration/saga_log.fbs
- k1/contracts/flatbuffers/layer3_execution/saga_integration.fbs
- k1/contracts/flatbuffers/layer4_runtime/saga_state.fbs
- k1/contracts/flatbuffers/layer5_infrastructure/saga_persistence.fbs
...
related_diagrams:
- k1_saga_pattern_error_recovery
- k1_compensating_transaction_flow
- k1_saga_coordinator_architecture
- k1_failure_detection_mechanism
- k1_rollback_orchestration
- k1_saga_state_management
- k1_saga_log_persistence
research_citations:
- "Sagas" by Hector Garcia-Molina and Kenneth Salem (1987)
- "Compensating Transactions" by Jim Gray (1981)
- "Long-Running Transactions" by Gerhard Weikum and Gottfried Vossen (2001)
- "Saga Pattern in Microservices" by Chris Richardson (2017)
- "Distributed Systems: Principles and Paradigms" by Andrew S. Tanenbaum and Maarten Van Steen (2007)
- "Fault-Tolerant Distributed Computing" by Rachid Guerraoui and Luís Rodrigues (2005)
propagation:
  triggers:
  ...
  - tests/k1/l2_orchestration/test_rollback_orchestrator.py
  - tests/k1/l3_execution/test_saga_integration.py
  - tests/k1/l4_runtime/test_saga_state.py
  - tests/k1/l5_infrastructure/test_saga_log.py
  - tests/integration/test_saga_error_recovery.py
  - tests/performance/test_saga_rollback_latency.py
---
