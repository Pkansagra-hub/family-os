---
adr_number: '0044b'
title: FlatBuffers Binary Serialization
status: ACCEPTED
...
affected_modules:
- k0.bridge.flatbuffers
- k0.serialization
- k1.bridge.flatbuffers
concerns:
- architecture
- cost
- observability
...
research_citations:
- "FlatBuffers Architecture (Google, 2014)"
- "Binary Serialization (Fowler & Parsons, 2004)"
- "Zero-Copy Deserialization (Reed et al., 1999)"
  - ADR-0012
  - ADR-0044
  - ADR-0044b
  affected_contracts:
