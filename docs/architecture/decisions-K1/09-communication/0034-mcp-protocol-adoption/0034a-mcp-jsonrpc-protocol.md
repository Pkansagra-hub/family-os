...
affected_layers:
  ...
  - layer4_runtime
affected_modules:
  - k1.l3_execution.mcp_jsonrpc_handler
authors:
...
propagation:
  triggers:
    - Changing JSON-RPC 2.0 specifications
    - Modifying error handling for RPC calls
  ...
  affected_tests:
    - tests/k1/l3_execution/test_mcp_jsonrpc_protocol.py
related_adrs:
  - ADR-0030a
  - ADR-0033
  - ADR-0034
