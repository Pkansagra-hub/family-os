...
- R7 Deep Dive §6: [Database Tables Accessed](R7_TRUTH_WRITER_DEEP_DIVE.md#6-database-tables-accessed)
...
- R7 Deep Dive §8: [DecisionRouter & Layer Writers](R7_TRUTH_WRITER_DEEP_DIVE.md#8-decisionrouter--layer-writers)
