...
|---|---|---|---|---|---|---|---|
| 1 | Baseline Casual — STANDARD / neutral / no capsule | `standard` | neutral | none | 6719 | 6 | OK |
| 2 | Standard + Full Capsule — parent / neutral / all blocks | `standard` | neutral | freshness-footer, self, prefer | 7361 | 6 | OK |
| 3 | Standard + Elevated Affect — dad stressed / task running | `standard` | elevated | freshness-footer, self, prefer | 7379 | 6 | OK |
| 4 | Standard + Crisis Affect + Conscience — emergency scenario | `standard` | crisis | freshness-footer, self, househ | 7193 | 3 | OK |
| 5 | Standard — Child View / Riley / teen role | `standard` | neutral | freshness-footer, self, prefer | 7124 | 6 | OK |
| 6 | Clarify Ask — CLARIFY_ASK / ambiguous request | `clarify_ask` | neutral | freshness-footer, self | 2281 | 3 | OK |
| 7 | Clarify Ask Depth 1 — CLARIFY_ASK / re-asking after unanswered | `clarify_ask` | neutral | freshness-footer, self | 2251 | 3 | OK |
| 8 | Clarify Resolve — CLARIFY_RESOLVE / user answered | `clarify_resolve` | neutral | freshness-footer, self | 3754 | 5 | OK |
| 9 | HITL Relay — worker needs booking approval | `hitl_relay` | neutral | freshness-footer, self, prefer | 2885 | 2 | OK |
| 10 | HITL Resolve — user approved booking | `hitl_resolve` | neutral | freshness-footer, self | 2507 | 3 | OK |
| 11 | Present — task result ready / grocery order placed | `present` | neutral | freshness-footer, self, prefer | 3673 | 3 | OK |
| 12 | Weave — async results while chatting about dinner | `weave` | neutral | freshness-footer, self | 3287 | 3 | OK |
| 13 | Error — task failed (plumber booking timeout) | `error` | neutral | freshness-footer, self | 2051 | 2 | OK |
| 14 | Cancel — user cancelled the plumber search | `cancel` | neutral | freshness-footer, self | 2101 | 3 | OK |
| 15 | Interrupt — new message while task in progress | `interrupt` | neutral | freshness-footer, self, prefer | 6018 | 6 | OK |
| 16 | Stale Capsule Warning — STANDARD / stale grounding | `standard` | neutral | freshness-footer, self, househ | 6975 | 6 | OK |
| 17 | Positive Affect — weekend morning / low arousal | `standard` | elevated | freshness-footer, self | 6989 | 6 | OK |
| 18 | Calendar Domain — STANDARD / domain=calendar / PIN tier | `standard` | neutral | freshness-footer, self, prefer | 7316 | 6 | OK |
