...
|---|---|---|---|---|---|---|---|
| 1 | Baseline Casual — STANDARD / neutral / no capsule | `standard` | neutral | none | 6401 | 6 | OK |
| 2 | Standard + Full Capsule — parent / neutral / all blocks | `standard` | neutral | freshness-footer, self, prefer | 6946 | 6 | OK |
| 3 | Standard + Elevated Affect — dad stressed / task running | `standard` | elevated | freshness-footer, self, prefer | 6963 | 6 | OK |
| 4 | Standard + Crisis Affect + Conscience — emergency scenario | `standard` | crisis | freshness-footer, self, househ | 6778 | 3 | OK |
| 5 | Standard — Child View / Riley / teen role | `standard` | neutral | freshness-footer, self, prefer | 6709 | 6 | OK |
| 6 | Clarify Ask — CLARIFY_ASK / ambiguous request | `clarify_ask` | neutral | freshness-footer, self | 1866 | 3 | OK |
| 7 | Clarify Ask Depth 1 — CLARIFY_ASK / re-asking after unanswered | `clarify_ask` | neutral | freshness-footer, self | 1836 | 3 | OK |
| 8 | Clarify Resolve — CLARIFY_RESOLVE / user answered | `clarify_resolve` | neutral | freshness-footer, self | 3339 | 5 | OK |
| 9 | HITL Relay — worker needs booking approval | `hitl_relay` | neutral | freshness-footer, self, prefer | 2470 | 2 | OK |
| 10 | HITL Resolve — user approved booking | `hitl_resolve` | neutral | freshness-footer, self | 2092 | 3 | OK |
| 11 | Present — task result ready / grocery order placed | `present` | neutral | freshness-footer, self, prefer | 3258 | 3 | OK |
| 12 | Weave — async results while chatting about dinner | `weave` | neutral | freshness-footer, self | 2872 | 3 | OK |
| 13 | Error — task failed (plumber booking timeout) | `error` | neutral | freshness-footer, self | 1636 | 2 | OK |
| 14 | Cancel — user cancelled the plumber search | `cancel` | neutral | freshness-footer, self | 1685 | 3 | OK |
| 15 | Interrupt — new message while task in progress | `interrupt` | neutral | freshness-footer, self, prefer | 5603 | 6 | OK |
| 16 | Stale Capsule Warning — STANDARD / stale grounding | `standard` | neutral | freshness-footer, self, househ | 6559 | 6 | OK |
| 17 | Positive Affect — weekend morning / low arousal | `standard` | elevated | freshness-footer, self | 6574 | 6 | OK |
...
== GROUNDING (live SpaceGraph projection) ==
- [self] / [preferences] / [household] / [routines] = WHO the user is
  and WHO/WHAT is in their home. Trust these over chat history.
- The [grounding freshness] footer flags STALE projections.
- For refusal rules see the CONSCIENCE block above (do NOT re-derive).
- These blocks are NOT a tool allowlist; tools are listed under `tools=[...]`.
