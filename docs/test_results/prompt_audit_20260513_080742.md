...
|---|---|---|---|---|---|---|---|
| 1 | Baseline Casual — STANDARD / neutral / no capsule | `standard` | neutral | none | 6910 | 6 | OK |
| 2 | Standard + Full Capsule — parent / neutral / all blocks | `standard` | neutral | freshness-footer, self, prefer | 7550 | 6 | OK |
| 3 | Standard + Elevated Affect — dad stressed / task running | `standard` | elevated | freshness-footer, self, prefer | 7567 | 6 | OK |
| 4 | Standard + Crisis Affect + Conscience — emergency scenario | `standard` | crisis | freshness-footer, self, space- | 7382 | 3 | OK |
| 5 | Standard — Child View / Riley / teen role | `standard` | neutral | freshness-footer, self, prefer | 7312 | 6 | OK |
...
| 8 | Clarify Resolve — CLARIFY_RESOLVE / user answered | `clarify_resolve` | neutral | freshness-footer, self | 3872 | 5 | OK |
...
| 15 | Interrupt — new message while task in progress | `interrupt` | neutral | freshness-footer, self, prefer | 6206 | 6 | OK |
| 16 | Stale Capsule Warning — STANDARD / stale grounding | `standard` | neutral | freshness-footer, self, space- | 7163 | 6 | OK |
| 17 | Positive Affect — weekend morning / low arousal | `standard` | elevated | freshness-footer, self | 7178 | 6 | OK |
| 18 | Calendar Domain — STANDARD / domain=calendar / PIN tier | `standard` | neutral | freshness-footer, self, prefer | 7504 | 6 | OK |
| 19 | Live Repro Turn 1 — greeting only / STANDARD | `standard` | neutral | freshness-footer, self, prefer | 7510 | 6 | OK |
| 20 | Live Repro Turn 2 — preamble + task request / STANDARD | `standard` | elevated | freshness-footer, self, prefer | 7515 | 6 | OK |
